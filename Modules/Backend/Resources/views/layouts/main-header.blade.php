<header class="main-header">
    ...
    <a href="{{ route('homepage') }}" class="logo">
        ...
        <span class="logo-lg"><b>Vietphuong</b> pharma</span>
    </a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu" style="min-height: 50px;">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="min-height: 50px;">
                        <img src="{{ cxl_asset('backend/dist/img/user2-160x160.jpg') }}" class="user-image" alt="User Image">
                        <span class="hidden-xs">{!! $user ? $user->username : "" !!}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
