            ...
            <table class="table table-striped table-bordered table-style" id="datatables">
                <thead>
                    <tr>
                        ...
                        <th class="un-orderable-col">Số thứ tự hiển thị</th>
                        <th class="un-orderable-col">Tiêu đề</th>
                        <th class="un-orderable-col">Menu con của</th>
                ...
                @foreach($data as $key => $row)
                    <tr>
                        ...
                        <td>{{ $row->order }}</td>
                        <td>{{ $row->title }}</td>
                        <td>{{ !empty($row->parent_id) ? $row->parent->title : '-' }}</td>
                        <td>{{ !empty($row->link) ? $row->link : '-' }}</td>
