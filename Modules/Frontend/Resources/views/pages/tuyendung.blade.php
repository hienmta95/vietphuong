...
@section('page_title', 'Thông tin tuyển dụng')

@section('seo_title')
    Tuyển dụng Việt Phương pharma
@endsection
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="breadcrum">
                    ...
                    <span class="text-green">Thông tin tuyển dụng</span>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 right">
                    ...
                    <div class="tuyendung-content">
                        {!! $info['tuyendung_description'] !!}
                        <br>
                        <br>
                        <ul class="tuyendung-list">
                            @foreach($tuyendunglist as $item)
                                <li>
